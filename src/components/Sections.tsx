...
import { TextEditorSection } from "@/components/sections/text-editor/TextEditorSection.tsx";
  ...
  return (
    <Tabs value={tab} onValueChange={setTab} className="mt-4 flex w-full flex-col items-center">
      <TabsList className="w-full max-w-md">
        <TabsTrigger value={TabNames.text}>Text</TabsTrigger>
      ...
      <TabsContent value={TabNames.text} className="w-full max-w-md">
        <TextEditorSection />
      </TabsContent>
